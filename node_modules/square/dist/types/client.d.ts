...
/** Current SDK version */
export declare const SDK_VERSION = "39.0.0";
export declare class Client implements ClientInterface {
    ...
    readonly bookingCustomAttributesApi: BookingCustomAttributesApi;
    ...
    readonly customerCustomAttributesApi: CustomerCustomAttributesApi;
    ...
    readonly locationCustomAttributesApi: LocationCustomAttributesApi;
    readonly locationsApi: LocationsApi;
    readonly loyaltyApi: LoyaltyApi;
    readonly merchantCustomAttributesApi: MerchantCustomAttributesApi;
    readonly merchantsApi: MerchantsApi;
    readonly mobileAuthorizationApi: MobileAuthorizationApi;
    readonly oAuthApi: OAuthApi;
    readonly orderCustomAttributesApi: OrderCustomAttributesApi;
    ...
    readonly webhookSubscriptionsApi: WebhookSubscriptionsApi;
